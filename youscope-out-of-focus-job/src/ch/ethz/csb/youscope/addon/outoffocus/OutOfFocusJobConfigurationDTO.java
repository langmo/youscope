...
public class OutOfFocusJobConfigurationDTO extends JobConfiguration implements ImageProducerConfiguration
{
	/**
	 * Serial version UID.
	 */
	...
	{
		OutOfFocusJobConfigurationDTO clone = (OutOfFocusJobConfigurationDTO)super.clone();
