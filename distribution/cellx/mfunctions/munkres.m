function [assignVec, cost, assignment] = munkres(costMat)
...
[assignedrows,assignedcols]=find(assignment);
assignVec(assignedrows,1)=assignedcols;


% % remove invalid assignments and create assignVec
% for nassign = 1: length(assignVec)
%     if assignVec(nassign)~=0
%         if ~finiteIndex(nassign,assignVec(nassign))
%             assignment(nassign,assignVec(nassign)) = 0;
%             assignVec(nassign) =0;
%         end
%     end
% end
