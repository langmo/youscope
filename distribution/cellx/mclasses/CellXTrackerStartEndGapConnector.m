classdef CellXTrackerStartEndGapConnector < handle
...
%         mergingNodePairs
    ...
    methods
        ...
        function obj = CellXTrackerStartEndGapConnector(config,fset,tlines,neighbors,terminalCost)
            ...
            if pairCostTag==0
               ...
               gappingCost = this.computePrimaryCostOf2Cells([fileSetIndex1, segmentationIndex1],...
                ...
                ret = gappingCost + additionalOverlapGapingCost;
                 ...
                 error('split-merge should not happen now')
