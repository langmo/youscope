classdef CellXIntensityExtractor < handle
    ...
    methods
        ...
        function obj = CellXIntensityExtractor(config, fSet, detectedCells)           
            obj.config        = config;
            obj.fileSet       = fSet;
        ...
        function measureIntensities(this,intensityCount)
            ...
            for sc = 1:nrCells
                ...
                quartiles = quantile(totalIntensityDistribution,3);
                ...
                quartiles = quantile(totalMembraneIntensityDistribution,3);
                ...
                quartiles = quantile(totalNuclearIntensityDistribution,3);
                ...
                quartiles = quantile(mostBrightAreaDistribution,3);
