 ...
 *
 */
public class AddonFactoryAdapter implements AddonFactory
{
	...
	{
		public final Class<? extends ConfigurationAddon<C>> configurationAddonClass;
		public final ConfigurationMetadata<C> metadata; 
		...
		SupportedAddon(Class<? extends ConfigurationAddon<C>> addonClass, Class<? extends Component> componentClass, ConfigurationMetadata<C> metadata)
		{
		...
		SupportedAddon(Class<? extends ConfigurationAddon<C>> addonClass, CustomAddonCreator<C,?> customCreator, ConfigurationMetadata<C> metadata)
		{
		...
		SupportedAddon(String typeIdentifier, Class<C> configurationClass, Class<? extends Component> componentClass)
		{
			...
			this.metadata = new GenericConfigurationMetadata<C>(typeIdentifier, configurationClass, componentClass);
			this.componentClass = componentClass;
			this.customCreator = null;
		}
		SupportedAddon(String typeIdentifier, Class<C> configurationClass, CustomAddonCreator<C,?> customCreator)
		{
			...
			this.configurationClass = configurationClass;
			this.typeIdentifier = typeIdentifier;
			this.metadata = new GenericConfigurationMetadata<C>(typeIdentifier, configurationClass, customCreator.getComponentInterface());
			this.componentClass = null;
			this.customCreator = customCreator;
		}
		ConfigurationAddon<C> createConfigurationAddon(YouScopeClient client, YouScopeServer server) throws AddonException
		{
			if(configurationAddonClass != null)
			{
				Constructor<? extends ConfigurationAddon<C>> constructor;
				try {
			...
			{
				return new GenericConfigurationAddon<C>(typeIdentifier, configurationClass, componentClass, client, server);
			}
			else
	 ...
	 */
	public <C extends Configuration> AddonFactoryAdapter(Class<? extends ConfigurationAddon<C>> configurationAddonClass, Class<? extends Component> componentClass, ConfigurationMetadata<C> metadata) 
	{
	 ...
	 * @param componentClass The component which can be created by the addon.
	 */
	public <C extends Configuration> AddonFactoryAdapter(String typeIdentifier, Class<C> configurationClass, Class<? extends Component> componentClass)
	{
	 ...
	 * @param metadata Metadata about this addon.
	 */
	public <C extends Configuration> AddonFactoryAdapter(Class<? extends ConfigurationAddon<C>> configurationAddonClass, CustomAddonCreator<C,?> customCreator, ConfigurationMetadata<C> metadata)
	{
	 ...
	 * @param customCreator A custom creator to initialize the component given the configuration.
	 */
	public <C extends Configuration> AddonFactoryAdapter(String typeIdentifier, Class<C> configurationClass, CustomAddonCreator<C,?> customCreator)
	{
	 ...
	 */
	public <C extends Configuration> void addAddon(Class<? extends ConfigurationAddon<C>> configurationAddonClass, CustomAddonCreator<C,?> customCreator, ConfigurationMetadata<C> metadata)
	{
	 ...
	 * @param metadata
	 */
	public <C extends Configuration> void addAddon(Class<? extends ConfigurationAddon<C>> configurationAddonClass, Class<? extends Component> componentClass, ConfigurationMetadata<C> metadata)
	{
	...
	@Override
	public ConfigurationAddon<?> createConfigurationAddon(
