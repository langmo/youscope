 ...
 * Furthermore, we recommend to design the interface functions such that they are as independet from the specific addon implementation
 * as possible.
 * 
 * @author Moritz Lang
 * 
 */
public interface GeneralPurposeAddon extends Remote
{
	/**
