...
public interface Configuration extends Cloneable, Serializable 
{
	 ...
	 * unit or the person who created the configuration (e.g. CSB, ETH, Smith, Cindarella), and YYY stands for an identifier
	 * of the specific kind of configuration (e.g. AutofocusJob, PlatePosition, MicroplateMeasurement). Optionally, additional hierachy levels can be
	 * defined by additional separators ::, e.g. "CSB::AutofocusJob::Version1.1"
	 * The identifier should not contain spaces, non-ASCII characters, or colons (except for hierachy level separation). Identifiers should start with
