...
public class SingleComponentDefinitionPanel<C extends Configuration> extends DynamicPanel
{
	...
	private ConfigurationAddon<? extends C> currentAddon = null;
	...
	public String getTypeIdentifier()
	{
		if(currentAddon == null)
			return null;
		return currentAddon.getConfigurationMetadata().getTypeIdentifier();
	}
	 ...
	 */
	public ConfigurationMetadata<? extends C> getConfigurationMetadata()
	{
		if(currentAddon == null)
			return null;
		return currentAddon.getConfigurationMetadata();
	}
	...
	private void displayAddonConfiguration(ConfigurationMetadata<? extends C> metadata)
	{
		if(currentAddon != null)
		{
		...
		try 
		{
			currentAddon = client.getAddonProvider().createConfigurationAddon(metadata.getTypeIdentifier(), configurationType);
