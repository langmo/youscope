...
public class JobConfigurationPanel<T extends JobConfiguration> extends JPanel
{
	...
	private Vector<ConfigurationAddonListener<? super T>>	configurationListeners	= new Vector<ConfigurationAddonListener<? super T>>();
	...
	private void createJob()
	{
		...
		for(ConfigurationAddonListener<? super T> listener : configurationListeners)
		{
	 ...
	 * @param listener
	 */
	public void addConfigurationListener(ConfigurationAddonListener<? super T> listener)
	{
	 ...
	 * @param listener
	 */
	public void removeConfigurationListener(ConfigurationAddonListener<? super T> listener)
	{
