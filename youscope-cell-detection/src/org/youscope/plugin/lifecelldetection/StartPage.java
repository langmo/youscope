 ...
 * 
 */
class StartPage extends MeasurementAddonUIPage<CellDetectionMeasurementConfiguration>
{
	...
	public void createUI(YouScopeFrame parentFrame)
	{
		...
		// Descriptive image
		ImageIcon microplateMeasurementIcon = ImageLoadingTools.getResourceIcon("org/youscope/plugin/lifecelldetection/images/life-cell-detection.jpg", "Life Cell Detection");
