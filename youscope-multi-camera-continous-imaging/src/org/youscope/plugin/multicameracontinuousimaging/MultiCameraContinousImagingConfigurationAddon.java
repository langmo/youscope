 ...
 * @author Moritz Lang
 */
class MultiCameraContinousImagingConfigurationAddon implements MeasurementConfigurationAddon<MultiCameraContinousImagingConfigurationDTO>
{

	private ArrayList<ComponentAddonUIListener<? super MultiCameraContinousImagingConfigurationDTO>> configurationListeners = new ArrayList<ComponentAddonUIListener<? super MultiCameraContinousImagingConfigurationDTO>>();
	...
	@Override
	public  MultiCameraContinousImagingConfigurationDTO getConfiguration()
	{
	...
	private void initilizeFrame() throws RemoteException
	{
		...
		MultiCameraContinousImagingConfigurationDTO configuration = getConfiguration();
	...
	private void createMeasurement()
	{
		...
		for(ComponentAddonUIListener<? super MultiCameraContinousImagingConfigurationDTO> listener : configurationListeners)
		{
	...
	private class StartPage extends JPanel
	{
		...
		StartPage()
		{
			...
			// Descriptive image
			ImageIcon microplateMeasurementIcon = ImageLoadingTools.getResourceIcon("org/youscope/plugin/multicameracontinuousimaging/images/continous-imaging.jpg", "Multi-Camera Continous Imaging Measurement");
	...
	@Override
	public void addUIListener(ComponentAddonUIListener<? super MultiCameraContinousImagingConfigurationDTO> listener)
	{
		configurationListeners.add(listener);
	}

	@Override
	public void removeUIListener(ComponentAddonUIListener<? super MultiCameraContinousImagingConfigurationDTO> listener)
	{
