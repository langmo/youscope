 ...
 *
 */
public class StartPage extends MeasurementAddonUIPage<MultiCameraContinousImagingConfiguration>
{
	/**
	 * Serial Version UID.
	 */
	private static final long	serialVersionUID	= 2311117369656492466L;
	@Override
	...
	public void createUI(YouScopeFrame frame)
	{
		...
		descriptionPane.setText("<html><p style=\"font-size:small;margin-top:0px;\"><b>Description:</b></p>" +
				"<p style=\"font-size:small;margin-top:4px;margin-bottom:0px\">A multi-camera continuous imaging measurement is used to (rapidly) take images with several cameras in parallel at the current position every given period.</p>"+
		...
		// Descriptive image
		ImageIcon measurementIcon = ImageLoadingTools.getResourceIcon("org/youscope/plugin/multicameracontinuousimaging/images/continous-imaging.jpg", "Multi-Camera Continous Imaging Measurement");
