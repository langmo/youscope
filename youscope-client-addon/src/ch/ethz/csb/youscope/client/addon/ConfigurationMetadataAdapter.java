 ...
 * @param <C>
 */
public class ConfigurationMetadataAdapter<C extends Configuration>  implements ConfigurationMetadata<C> 
{
	 ...
	 */
	public ConfigurationMetadataAdapter(final String typeIdentifier,
	...
	public ImageIcon getIcon() {
		if(iconPath == null)
			return null;
		URL iconURL = ConfigurationMetadataAdapter.class.getClassLoader().getResource(iconPath);
		if (iconURL != null)
