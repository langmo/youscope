...
public class MicroplateMeasurementConfigurationDTO extends MeasurementConfiguration implements Cloneable, Serializable, JobContainerConfiguration
{
	/**
	 * Serial version UID.
	 */
	...
	{
		MicroplateMeasurementConfigurationDTO clone = (MicroplateMeasurementConfigurationDTO)super.clone();
		...
		clone.microplatePositions = (MicroplatePositionConfigurationDTO)microplatePositions.clone();
