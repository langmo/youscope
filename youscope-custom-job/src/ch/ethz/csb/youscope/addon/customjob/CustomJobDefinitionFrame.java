...
class CustomJobDefinitionFrame
{
	...
	{
		this(client, server, frame, new CustomJobConfigurationDTO());
	}
	CustomJobDefinitionFrame(YouScopeClient client, YouScopeServer server, YouScopeFrame frame, final CustomJobConfigurationDTO customJob)
	{
		this.frame = frame;
		this.client = client;
