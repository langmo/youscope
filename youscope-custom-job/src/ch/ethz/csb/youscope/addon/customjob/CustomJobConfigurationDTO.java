...
public class CustomJobConfigurationDTO extends JobConfiguration implements JobContainerConfiguration
{
	...
	@Override
	public CustomJobConfigurationDTO clone() throws CloneNotSupportedException
	{
		CustomJobConfigurationDTO clone = (CustomJobConfigurationDTO)super.clone();
