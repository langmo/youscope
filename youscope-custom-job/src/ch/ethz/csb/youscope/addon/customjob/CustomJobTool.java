...
class CustomJobTool implements ToolAddon, ActionListener
{
	...
	private JList<CustomJobConfigurationDTO> customJobsList;
	/**
	 * Constructor.
	...
	protected class FrameInitializer implements Runnable
	{
		...
		public void run()
		{
	        ...
	        deleteCustomJobButton.addActionListener(new ActionListener()
	            {
	                ...
	                public void actionPerformed(ActionEvent e)
	                {
	                	CustomJobConfigurationDTO customJob = customJobsList.getSelectedValue();
	                    if (customJob == null)
	                        return;
	        ...
	        customJobsList = new JList<CustomJobConfigurationDTO>();
	        customJobsList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
	        class CustomJobCellRenderer extends JLabel implements ListCellRenderer<CustomJobConfigurationDTO> 
			{
				/**
				 * Serial Version UID
				 */
				...
				@Override
				public Component getListCellRendererComponent(JList<? extends CustomJobConfigurationDTO> list, CustomJobConfigurationDTO value, int index, boolean isSelected, boolean cellHasFocus)
			    {
