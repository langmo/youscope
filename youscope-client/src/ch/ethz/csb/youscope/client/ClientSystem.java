...
class ClientSystem
{
    ...
    @Deprecated
    static Iterable<JobConfigurationAddonFactory> getJobAddons()
    {
        ServiceLoader<JobConfigurationAddonFactory> jobAddons =
                ServiceLoader.load(JobConfigurationAddonFactory.class,
                        ClientSystem.class.getClassLoader());
        return jobAddons;
    }
        
    static Iterable<MeasurementConfigurationAddonFactory> getMeasurementAddons()
    {
        ServiceLoader<MeasurementConfigurationAddonFactory> jobAddons =
                ServiceLoader.load(MeasurementConfigurationAddonFactory.class,
                        ClientSystem.class.getClassLoader());
        return jobAddons;
    }
    
    static Iterable<MeasurementPostProcessorAddonFactory> getMeasurementPostProcessorAddons()
    {
        ServiceLoader<MeasurementPostProcessorAddonFactory> addons =
                ServiceLoader.load(MeasurementPostProcessorAddonFactory.class,
                        ClientSystem.class.getClassLoader());
        return addons;
    }
    ...
    @Deprecated
    static JobConfigurationAddonFactory getJobAddon(String addonID)
    {
        for (JobConfigurationAddonFactory addon : getJobAddons())
        {
        	if(addon.supportsConfigurationID(addonID))
                return addon;
        }
        return null;
    }
    
    static MeasurementConfigurationAddonFactory getMeasurementAddon(String addonID)
    {
        for (MeasurementConfigurationAddonFactory addon : getMeasurementAddons())
        {
        	if(addon.supportsConfigurationID(addonID))
                return addon;
        }
    ...
    static MeasurementPostProcessorAddonFactory getMeasurementPostProcessorAddon(String addonID)
    {
    	for (MeasurementPostProcessorAddonFactory addon : getMeasurementPostProcessorAddons())
        {
    ...
    static Iterable<MicroplateTypeFactory> getMicroplateTypeAddons()
	{
    	ServiceLoader<MicroplateTypeFactory> microplateTypeAddons =
            ServiceLoader.load(MicroplateTypeFactory.class,
                    ClientSystem.class.getClassLoader());
    	return microplateTypeAddons;
	}

	
	static MicroplateTypeFactory getMicroplateTypeAddon(String addonID)
	{
		for (MicroplateTypeFactory addon : getMicroplateTypeAddons())
        {
