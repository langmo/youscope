...
class MeasurementView extends JPanel implements Runnable, ImageFolderListener
{
	...
	public void run()
	{
		...
		ImageIcon selectImagingJobIcon = ImageLoadingTools.getResourceIcon("ch/ethz/csb/youscope/client/addon/tool/measurementviewer/images/arrowLeft.png", "select previous tab first");
        ...
        Iterator<MeasurementPostProcessorAddonFactory> factories = client.getMeasurementPostProcessorAddons().iterator();
	...
	private class StartProcessorButton extends JButton implements ActionListener
	{
		...
		StartProcessorButton(MeasurementPostProcessorAddonFactory addonFactory, String addonID)
		{
			super("Open Plugin");
			setOpaque(false);
		...
		public void actionPerformed(ActionEvent arg0)
		{
			...
			MeasurementPostProcessorAddon addon = addonFactory.createMeasurementConfigurationAddon(addonID, client, server, measurementFolder.getAbsolutePath());
