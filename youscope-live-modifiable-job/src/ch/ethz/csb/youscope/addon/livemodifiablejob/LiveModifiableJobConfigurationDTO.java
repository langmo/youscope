...
public class LiveModifiableJobConfigurationDTO extends JobConfiguration implements JobContainerConfiguration
{
    /**
    ...
    {
        LiveModifiableJobConfigurationDTO clone = (LiveModifiableJobConfigurationDTO) super.clone();
