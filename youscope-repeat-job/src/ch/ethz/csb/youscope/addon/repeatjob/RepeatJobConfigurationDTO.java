...
public class RepeatJobConfigurationDTO extends JobConfiguration implements JobContainerConfiguration
{
	...
	{
		RepeatJobConfigurationDTO clone = (RepeatJobConfigurationDTO)super.clone();
