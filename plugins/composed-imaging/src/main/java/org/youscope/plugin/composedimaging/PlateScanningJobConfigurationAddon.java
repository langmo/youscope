...
class PlateScanningJobConfigurationAddon  extends ComponentAddonUIAdapter<PlateScanningJobConfiguration>
{
	...
	PlateScanningJobConfigurationAddon(YouScopeClient client, YouScopeServer server) throws AddonException
	{
		super(getMetadata(),  client, server);
	}
    
    static ComponentMetadataAdapter<PlateScanningJobConfiguration> getMetadata()
	{
    ...
    @Override
	protected Component createUI(PlateScanningJobConfiguration configuration) throws AddonException
	{
		setTitle("Plate Scanning Job");
		setResizable(true);
	...
	@Override
	protected void commitChanges(PlateScanningJobConfiguration configuration) {
