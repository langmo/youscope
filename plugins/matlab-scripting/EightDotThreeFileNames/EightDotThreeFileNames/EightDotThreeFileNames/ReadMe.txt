========================================================================
    DYNAMIC LINK LIBRARY: EightDotThreeFileNames-Projektübersicht
========================================================================

Diese EightDotThreeFileNames-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre EightDotThreeFileNames-Anwendung besteht.


EightDotThreeFileNames.vcxproj
...
EightDotThreeFileNames.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen EightDotThreeFileNames.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
