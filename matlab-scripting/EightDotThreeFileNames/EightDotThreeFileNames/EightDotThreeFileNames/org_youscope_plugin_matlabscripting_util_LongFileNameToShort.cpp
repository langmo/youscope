#include "jni.h"
#include <Windows.h>
#include "org_youscope_plugin_matlabscripting_util_LongFileNameToShort.h"

// This file converts a given windows file name into its "old" 8.3 representation.
JNIEXPORT jstring JNICALL Java_org_youscope_plugin_matlabscripting_util_LongFileNameToShort_toShortFileName(JNIEnv * env, jobject jobj, jstring fileName)
{
	jboolean iscopy;
	jstring jb;
	long     length = 0;
