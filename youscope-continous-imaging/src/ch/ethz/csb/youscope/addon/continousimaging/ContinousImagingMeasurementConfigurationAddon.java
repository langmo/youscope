 ...
 * @author Moritz Lang
 */
class ContinousImagingMeasurementConfigurationAddon implements MeasurementConfigurationAddon
{
	...
	@Override
	public  ContinousImagingMeasurementConfiguration getConfigurationData()
	{
	...
	private void initilizeFrame() throws RemoteException
	{
		...
		ContinousImagingMeasurementConfiguration configuration = getConfigurationData();
	...
	private class StartPage extends JPanel
	{
		...
		StartPage()
		{
			...
			// Descriptive image
			ImageIcon microplateMeasurementIcon = ImageLoadingTools.getResourceIcon("ch/ethz/csb/youscope/addon/continousimaging/images/continous-imaging.jpg", "Continous Imaging Measurement");
