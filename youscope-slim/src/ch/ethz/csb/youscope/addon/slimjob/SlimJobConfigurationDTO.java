...
public class SlimJobConfigurationDTO extends JobConfiguration implements ImageProducerConfiguration
{
	/**
	 * Serial version UID.
	 */
	...
	{
		SlimJobConfigurationDTO clone = (SlimJobConfigurationDTO)super.clone();
		return clone;
	}
