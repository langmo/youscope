...
class StartPage extends MeasurementAddonUIPage<ComposedImagingMeasurementConfiguration>
{
	...
	public void createUI(YouScopeFrame frame)
	{
		...
		// Descriptive image
		ImageIcon microplateMeasurementIcon = ImageLoadingTools.getResourceIcon("org/youscope/plugin/composedimaging/images/composed-imaging.jpg", "Composed Imaging Measurement");
