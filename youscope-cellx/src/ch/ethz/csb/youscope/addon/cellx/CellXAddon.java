...
import ch.ethz.csb.youscope.shared.addon.celldetection.CellDetectionException;
...
import ch.ethz.csb.youscope.shared.table.TableDataAdapter;
...
class CellXAddon extends ResourceAdapter<CellXConfiguration> implements CellDetectionAddon
{
	...
	public CellDetectionResult detectCells(ImageEvent detectionImage, ImageEvent[] quantificationImages) throws CellDetectionException, RemoteException
	{
		...
		URL matlabFile = getClass().getClassLoader().getResource("ch/ethz/csb/youscope/addon/cellx/CellXInvoker.m");
		if(matlabFile == null)
