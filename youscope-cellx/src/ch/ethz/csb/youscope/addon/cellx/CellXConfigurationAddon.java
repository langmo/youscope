 ...
 * @author Moritz Lang
 */
class CellXConfigurationAddon  extends ConfigurationAddonAdapter<CellXConfiguration>
{
	...
	static ConfigurationMetadataAdapter<CellXConfiguration> getMetadata()
	{
		return new ConfigurationMetadataAdapter<CellXConfiguration>(CellXConfiguration.TYPE_IDENTIFIER, 
