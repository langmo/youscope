...
class InputConfigurationPanel extends DynamicPanel
{
	...
	private void displayAddonConfiguration(ConfigurationMetadata<? extends JobConfiguration> inputOption)
	{
		if(currentAddon != null)
		{
		...
		try 
		{
			currentAddon = client.getAddonProvider().createConfigurationAddon(inputOption.getTypeIdentifier(), JobConfiguration.class);
