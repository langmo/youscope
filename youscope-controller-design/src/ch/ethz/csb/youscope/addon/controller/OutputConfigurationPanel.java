...
class OutputConfigurationPanel extends DynamicPanel
{
	...
	private ConfigurationAddon<? extends JobConfiguration> currentAddon = null;
	...
	private void displayAddonConfiguration(ConfigurationMetadata<? extends JobConfiguration> outputOption)
	{
		if(currentAddon != null)
		{
		...
		try 
		{
			currentAddon = client.getAddonProvider().createConfigurationAddon(outputOption.getTypeIdentifier(), JobConfiguration.class);
