...
public class Microplate implements Cloneable, Serializable, Configuration
{
	/**
	 * Serial Version UID.
	 */
	 ...
	 */
	public Microplate(MicroplateType microplateType)
	{
	 ...
	 */
	public Microplate(int numWellsX, int numWellsY, double wellWidth, double wellHeight)
	{
	 ...
	 */
	public Microplate(int numPositions)
	{
	 ...
	 * @return Returns TRUE if microplate dimensions changed.
	 */
	public boolean setMicroplateType(MicroplateType microplateType)
	{
