...
/**
 * Interface measurement should implement who allow the user to define different tasks manually, i.e. whose task structure is not fixed by
 * higher level configuration settings.
 * @author Moritz Lang
 */
