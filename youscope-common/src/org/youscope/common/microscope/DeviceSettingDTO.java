...
public class DeviceSettingDTO implements Cloneable, Serializable
{
	/**
	 * Serial Version UID.
	 */
	 ...
	 */
	public DeviceSettingDTO(String device, String property, String value)
	{
	 ...
	 * @param value the value to set.
	 */
	public DeviceSettingDTO(String device, String property, int value)
	{
		setDeviceProperty(device, property);
		setValue(value);
	}
	 ...
	 * @param value the value to set.
	 */
	public DeviceSettingDTO(String device, String property, float value)
	{
		setDeviceProperty(device, property);
		setValue(value);
	}
	 ...
	 */
	public DeviceSettingDTO(DeviceSettingDTO deviceSetting)
	{
	...
	@Override
	public DeviceSettingDTO clone()
	{
		try {
			return (DeviceSettingDTO) super.clone();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DeviceSettingDTO other = (DeviceSettingDTO) obj;
