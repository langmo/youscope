...
public interface MeasurementSaver extends Remote
{
	...
	/**
	 * Returns a table data listener which can be added to an table data producing job to save all produced data to the disk.
	 ...
	 * @throws RemoteException
	 */
	TableListener getSaveTableDataListener(String tableSaveName) throws RemoteException;
	 ...
	 * @throws RemoteException
	 */
	void setSaveSettings(MeasurementSaveSettings saveSettings) throws MeasurementRunningException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	MeasurementSaveSettings getSaveSettings() throws RemoteException;
