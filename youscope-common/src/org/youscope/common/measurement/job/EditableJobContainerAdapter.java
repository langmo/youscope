 ...
 * The sub-jobs can be accessed (e.g. the function {@link Job#executeJob(org.youscope.common.measurement.ExecutionInformation, Microscope, MeasurementContext)}) via {@link #getJobs()}.
 * @author Moritz Lang
 */
public abstract class EditableJobContainerAdapter extends JobAdapter implements EditableJobContainer
{
	 ...
	 */
	public EditableJobContainerAdapter(PositionInformation positionInformation) throws RemoteException
	{
