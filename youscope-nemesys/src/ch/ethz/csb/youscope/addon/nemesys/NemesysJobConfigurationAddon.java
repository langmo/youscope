...
import ch.ethz.csb.youscope.client.uielements.scripteditor.ScriptEditor;
 ...
 * @author Moritz Lang
 */
class NemesysJobConfigurationAddon extends ConfigurationAddonAdapter<NemesysJobConfiguration>
{
	...
	static ConfigurationMetadataAdapter<NemesysJobConfiguration> getMetadata()
	{
		return new ConfigurationMetadataAdapter<NemesysJobConfiguration>(NemesysJobConfiguration.TYPE_IDENTIFIER, 
	...
	private void plotProtocol()
	{
		...
		try {
			...
			ConfigurationAddonTools.displayConfigurationInvalid(e, getClient());
			return;
		}
