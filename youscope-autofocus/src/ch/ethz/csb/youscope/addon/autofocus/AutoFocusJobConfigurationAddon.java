 ...
 * @author Moritz Lang
 */
class AutoFocusJobConfigurationAddon extends ConfigurationAddonAdapter<AutoFocusJobConfiguration>
{
	...
	static ConfigurationMetadataAdapter<AutoFocusJobConfiguration> getMetadata()
	{
		return new ConfigurationMetadataAdapter<AutoFocusJobConfiguration>(AutoFocusJobConfiguration.TYPE_IDENTIFIER, 
