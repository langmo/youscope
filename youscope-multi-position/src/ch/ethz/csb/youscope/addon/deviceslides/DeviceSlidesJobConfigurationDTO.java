...
public class DeviceSlidesJobConfigurationDTO extends JobConfiguration implements JobContainerConfiguration
{
	...
	{
		DeviceSlidesJobConfigurationDTO job = (DeviceSlidesJobConfigurationDTO)super.clone();
