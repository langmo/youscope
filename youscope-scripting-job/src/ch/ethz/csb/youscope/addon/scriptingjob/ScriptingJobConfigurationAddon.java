 ...
 * @author Moritz Lang
 */
class ScriptingJobConfigurationAddon extends ConfigurationAddonAdapter<ScriptingJobConfiguration>
{
    /**
    ...
    static ConfigurationMetadataAdapter<ScriptingJobConfiguration> getMetadata()
	{
		return new ConfigurationMetadataAdapter<ScriptingJobConfiguration>(ScriptingJob.DEFAULT_TYPE_IDENTIFIER, 
