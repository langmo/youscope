...
final class ServerSystem
{
	...
	@Deprecated
	public static JobConstructionAddon getJobConstructionAddon(String addonID)
	{
		ServiceLoader<JobConstructionAddonFactory> addonFactories = ServiceLoader.load(JobConstructionAddonFactory.class, ConstructionContextImpl.class.getClassLoader());
		for(JobConstructionAddonFactory addon : addonFactories)
		{
			if(addon.supportsConfigurationID(addonID))
				return addon.createJobConstructionAddon(addonID);
		}
		return null;
	}

	public static MeasurementConstructionAddon getMeasurementConstructionAddon(String addonID)
	{
		ServiceLoader<MeasurementConstructionAddonFactory> addonFactories = ServiceLoader.load(MeasurementConstructionAddonFactory.class, ConstructionContextImpl.class.getClassLoader());
		for(MeasurementConstructionAddonFactory addon : addonFactories)
		{
			if(addon.supportsConfigurationID(addonID))
				return addon.createMeasurementConstructionAddon(addonID);
		}
		return null;
	}
