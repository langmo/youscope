...
class ConfigFileWriter extends ConfigFileManipulator
{
	...
	{
		String[] header = new String[] {"############################################################", "# Microscope Configuration File                            #", "# Generated by YouScope "+new YouScopeVersion("youscope-server").getMajorVersion()+"                                #", "# Compatible with Micro-Manager 1.4                        #", "# Created: " + new Date().toString(), "# Visit www.youscope.org                                   #", "############################################################"};
