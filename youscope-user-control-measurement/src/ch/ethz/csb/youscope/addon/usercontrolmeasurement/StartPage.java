 ...
 *
 */
class StartPage extends MeasurementConfigurationPage<UserControlMeasurementConfigurationDTO>
{
	...
	public void createUI(YouScopeFrame frame)
	{
		...
		// Descriptive image
		ImageIcon microplateMeasurementIcon = ImageLoadingTools.getResourceIcon("ch/ethz/csb/youscope/addon/usercontrolmeasurement/images/usercontrolmeasurement.jpg", "User Control Measurement");
